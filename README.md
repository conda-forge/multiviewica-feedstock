...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/multiviewica-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11219&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/multiviewica-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `multiviewica` can be installed with:

```
conda install multiviewica
```

It is possible to list all of the versions of `multiviewica` available on your platform with:
